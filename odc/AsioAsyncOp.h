...
namespace odc::core
{
    ...
    /**
     * @tparam Executor1 Associated I/O executor, see
     * https://www.boost.org/doc/libs/1_70_0/doc/html/boost_asio/reference/asynchronous_operations.html#boost_asio.reference.asynchronous_operations.associated_i_o_executor
     * @tparam Allocator1 Default allocation strategy, see
     * https://www.boost.org/doc/libs/1_70_0/doc/html/boost_asio/reference/asynchronous_operations.html#boost_asio.reference.asynchronous_operations.allocation_of_intermediate_storage
     */
    ...
    struct AsioAsyncOpImpl : AsioAsyncOpImplBase<SignatureArgTypes...>
    {
        /// See
        /// https://www.boost.org/doc/libs/1_70_0/doc/html/boost_asio/reference/asynchronous_operations.html#boost_asio.reference.asynchronous_operations.allocation_of_intermediate_storage
        using Allocator2 = typename boost::asio::associated_allocator<Handler, Allocator1>::type;

        /// See
        /// https://www.boost.org/doc/libs/1_70_0/doc/html/boost_asio/reference/asynchronous_operations.html#boost_asio.reference.asynchronous_operations.associated_completion_handler_executor
        using Executor2 = typename boost::asio::associated_executor<Handler, Executor1>::type;

        /// Ctor
        AsioAsyncOpImpl(const Executor1& ex1, Allocator1 alloc1, Handler&& handler)
            : fWork1(ex1)
            , fWork2(boost::asio::get_associated_executor(handler, ex1))
        ...
        {
            return boost::asio::get_associated_allocator(fHandler, fAlloc1);
        }
        auto GetEx2() const -> Executor2
        {
            return boost::asio::get_associated_executor(fWork2);
        }
      ...
      private:
        /// See
        /// https://www.boost.org/doc/libs/1_70_0/doc/html/boost_asio/reference/asynchronous_operations.html#boost_asio.reference.asynchronous_operations.outstanding_work
        boost::asio::executor_work_guard<Executor1> fWork1;
        boost::asio::executor_work_guard<Executor2> fWork2;
        Handler fHandler;
        Allocator1 fAlloc1;
    };
     ...
     * @tparam Executor Associated I/O executor, see
     * https://www.boost.org/doc/libs/1_70_0/doc/html/boost_asio/reference/asynchronous_operations.html#boost_asio.reference.asynchronous_operations.associated_i_o_executor
     * @tparam Allocator Default allocation strategy, see
     * https://www.boost.org/doc/libs/1_70_0/doc/html/boost_asio/reference/asynchronous_operations.html#boost_asio.reference.asynchronous_operations.allocation_of_intermediate_storage
     * @tparam CompletionSignature
     * @brief Interface for Asio-compliant asynchronous operation, see
    ...
    struct AsioAsyncOp<Executor, Allocator, SignatureReturnType(SignatureFirstArgType, SignatureArgTypes...)>
    {
        static_assert(std::is_void<SignatureReturnType>::value, "return value of CompletionSignature must be void");
      ...
      public:
            ...
            : AsioAsyncOp()
        {
            ...
            // Allocator2, see
            // https://www.boost.org/doc/libs/1_70_0/doc/html/boost_asio/reference/asynchronous_operations.html#boost_asio.reference.asynchronous_operations.allocation_of_intermediate_storage
            using OpAllocator = typename std::allocator_traits<typename Op::Allocator2>::template rebind_alloc<Op>;
            OpAllocator opAlloc;
            ...
            // Construct object
            auto ptr(new (mem) Op(std::move(ex1), std::move(alloc1), std::forward<Handler>(handler)));

            // Assign ownership to this object
            fImpl = ImplPtr(ptr,
                            [opAlloc](Impl* p) mutable
        ...
        explicit AsioAsyncOp(Handler&& handler)
            : AsioAsyncOp(boost::asio::system_executor(), std::forward<Handler>(handler))
        {
        }

        auto IsCompleted() -> bool
        {
            return (fImpl == nullptr) || fImpl->IsCompleted();
        }
