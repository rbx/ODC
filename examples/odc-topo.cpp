...
int main(int argc, char** argv)
{
    try {
        ...
        options.add_options()("dpl", bpo::value<string>(&dplTopoFilepath)->default_value(defaultDPLTopo), "Path to DPL topology file");
        options.add_options()("dd", bpo::value<string>(&ddTopoFilepath)->default_value(defaultDDTopo), "Path to Data Distribution topology file");
        options.add_options()("output,o", bpo::value<string>(&outputTopoFilepath)->default_value("topology.xml"), "Output topology filepath");
